...
namespace QRGuard_RESTful{

public class QRGuard{
...
namespace QRGuard{
    class Guard{
        ...
        public string? GuardGen(string name){
            ...
            string path = $"./pic/{name + delta_time}.jpg";
            QRCodeHelper.CreateQRCode(cipherBase64,"./pic/culture.jpg").Save(path);
